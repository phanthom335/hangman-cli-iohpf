    ...
    Hangman Cli Iohpf
    =================
    Fun terminal game that challenges players to conquer puzzles in ASCII art.
...
return {"score": score, "rounds": guessed_in, "won": score > 0}
    ...
    def build_parser() -> argparse.ArgumentParser:
        p = argparse.ArgumentParser(prog=APP_NAME, description="Fun terminal game that challenges players to conquer puzzles in ASCII art.")
